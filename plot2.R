## This file implements part 2 of the first assignment for the Data Exploratory Analysis course.
##
## If you want to directly create the PNG file, load this code as a source and call doPlot2ToPng()
##
...
## Reads data via readInputFromUrl and plots the date against the Global Active Power between 01/02/2007 and 02/02/2007
doPlot2 <- function() {
  initialize()
