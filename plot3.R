## This file implements part 3 of the first assignment for the Data Exploratory Analysis course.
##
## If you want to directly create the PNG file, load this code as a source and call doPlot3ToPng()
##
...
## Reads data via readInputFromUrl and plots Energy sub metering against the time for the 3 submetering types between 01/02/2007 and 02/02/2007
doPlot3 <- function() {
  initialize()
...
## Calls to doPlot but setting the device to a png file "plot2.png"
doPlot3ToPng <- function() {
